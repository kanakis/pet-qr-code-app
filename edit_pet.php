...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $_SESSION['success'] = "Pet '{$formData['name']}' has been updated successfully!";
            header("Location: index.php");
            exit;
            
        } catch (PDOException $e) {
            $errors[] = "Error updating pet: " . $e->getMessage();
        }
    }
    
    // Update pet array with form data for display
    $pet = array_merge($pet, $formData);
}
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <h1 class="mb-4">
            <i class="fas fa-edit"></i> Edit Pet: <?php echo htmlspecialchars($pet['name']); ?>
        </h1>
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="edit_pet.php?id=<?php echo $petId; ?>" class="needs-validation" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="owner_name" name="owner_name" 
                               value="<?php echo htmlspecialchars($pet['owner_name'] ?? ''); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="owner_contact" name="owner_contact" 
                               value="<?php echo htmlspecialchars($pet['owner_contact'] ?? ''); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="medical_history" name="medical_history" 
                                  rows="4"><?php echo htmlspecialchars($pet['medical_history'] ?? ''); ?></textarea>
